...
describe 'Guidelines:Page (4.0.0)' do
  ...
  before do
    ...
    allow_any_instance_of(AdminModule::Pages::GuidelinesPage400).to receive(:get_dynamic_url).and_return(HtmlSpec.url_for("guidelines-400.html"))
    ...
    allow_any_instance_of(AdminModule::Pages::GuidelinesPage400).to receive(:version_all_button).and_return(nil)
    allow_any_instance_of(AdminModule::Pages::GuidelinesPage400).to receive(:modify).and_return(nil)
  ...
  context "#version_all" do
    ...
    it "opens 'Versions All' page" do
      allow_any_instance_of(AdminModule::PageFactory).to receive(:guidelines_version_all_page).and_return(HtmlSpec.url_for("version_all_guidelines-400.html"))
  ...
  context "#open_guideline" do
    ...
    it "opens 'Guideline' page" do
      allow_any_instance_of(AdminModule::PageFactory).to receive(:guideline_page).and_return(HtmlSpec.url_for("version_all_guidelines-400.html"))
